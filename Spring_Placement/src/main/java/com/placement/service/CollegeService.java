...
public class CollegeService {
    ...
    public College update(College college, Integer id) {
    	College existCollege = clg.findById(id).get();
    	existCollege.setcollegeAdmin(college.getcollegeAdmin());
    	existCollege.setcollegeName(college.getcollegeName());
    	existCollege.setLocation(college.getLocation());
    	return existCollege;
    }
